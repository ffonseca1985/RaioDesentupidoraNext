...
export const BtnWhatsApp: FC<BtnWhatsAppProps> = ({ variant = 'default' }) => {
    const baseStyles = "group relative overflow-hidden bg-green-500 text-white rounded-lg transition-all duration-300 font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5";
